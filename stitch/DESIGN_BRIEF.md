...
- SurfaceGate Desk turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
...
- Ticket Operations - SurfaceGate Desk
- Ticket Editor - SurfaceGate Desk
- Queue and Status Management - SurfaceGate Desk
- Agent Workload - SurfaceGate Desk
- Insights - SurfaceGate Desk
- Settings and Preferences - SurfaceGate Desk
- Empty and Error Recovery - SurfaceGate Desk

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Ticket Operations - SurfaceGate Desk
...
SCREEN_SPEC_2:
- exact_screen_title: Ticket Editor - SurfaceGate Desk
...
SCREEN_SPEC_3:
- exact_screen_title: Queue and Status Management - SurfaceGate Desk
...
SCREEN_SPEC_4:
- exact_screen_title: Agent Workload - SurfaceGate Desk
...
SCREEN_SPEC_5:
- exact_screen_title: Insights - SurfaceGate Desk
...
SCREEN_SPEC_6:
- exact_screen_title: Settings and Preferences - SurfaceGate Desk
...
SCREEN_SPEC_7:
- exact_screen_title: Empty and Error Recovery - SurfaceGate Desk
